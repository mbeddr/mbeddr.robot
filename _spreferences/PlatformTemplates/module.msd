...
<solution name="com.mbeddr.demo.robot.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#com.mbeddr.demo.robot.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
